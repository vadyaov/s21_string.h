...
int main() {
    ...
    SRunner *runner1, *runner2, *runner3, *runner4, *runner5, *runner6, *runner7, *runner8,
            ...
            *runner23, *runner24, *runner25, *runner26;
...
*/
    ...
    s26 = suite_sscanf();
    runner26 = srunner_create(s26);
    srunner_set_fork_status(runner26, CK_NOFORK);
    srunner_run_all(runner26, CK_NORMAL);
    no_failed26 = srunner_ntests_failed(runner26);
    srunner_free(runner26);
